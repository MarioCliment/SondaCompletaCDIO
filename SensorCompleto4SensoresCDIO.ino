...
//////////////////////////////////////////////////////
  ...
  const char WiFiSSID[] = "Moto G Play 4311";
  const char WiFiPSK[] = "48484848";
#endif
...
//////////////////////////////////////////////////////
  ...
  String MyWriteAPIKey="R7IIW3PW0RE9EO07"; // Escribe la clave de tu canal ThingSpeak
#else 
...
void loop() {
  ...
  Acelerometro ACM;
  GPS Gps; 
  int salinidad, humedad, acelerometro;
  float temperatura,luminosidad,altitud,latitud;
     
  humedad=Slave.funcionHumedad (); 
  salinidad=Slave.funcionSalinidad (); 
  temperatura=Slave.funcionTemperatura();
  luminosidad=Slave.funcionLuminosidad();
  acelerometro=ACM.devuelveFlag();
  altitud=Gps.devuelveAltitud();
  latitud=Gps.devuelveLatitud();
...
//--------------------------------------------------------------------
 String data[ NUM_FIELDS_TO_SEND + 1];  // Podemos enviar hasta 8 datos
  ...
  Serial.print('\n'); 
    ...
    data[ 1 ] = String( salinidad ); //Escribimos el dato 1. Recuerda actualizar numFields
    #ifdef PRINT_DEBUG_MESSAGES
    ...
    data[ 2 ] = String( humedad ); //Escribimos el dato 2. Recuerda actualizar numFields
    #ifdef PRINT_DEBUG_MESSAGES
    ...
    data[ 4 ] = String( luminosidad ); //Escribimos el dato 2. Recuerda actualizar numFields
    #ifdef PRINT_DEBUG_MESSAGES
    ...
    data[ 5 ] = String( acelerometro); //Escribimos el dato 2. Recuerda actualizar numFields
    #ifdef PRINT_DEBUG_MESSAGES
    ...
    data[ 6 ] = String( latitud ); //Escribimos el dato 2. Recuerda actualizar numFields
    #ifdef PRINT_DEBUG_MESSAGES
    ...
    data[ 7 ] = String( altitud ); //Escribimos el dato 2. Recuerda actualizar numFields
    #ifdef PRINT_DEBUG_MESSAGES
